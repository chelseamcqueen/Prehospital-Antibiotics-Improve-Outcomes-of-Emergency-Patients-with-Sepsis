...
--CREATE VIEW qwu6617.PangiaB3041PT2 AS
SELECT
fp.Patient_DW_Id
,fp.Company_Code
,fp.Coid
...
WHERE fp.Admission_Date BETWEEN '2018-03-01' AND '2019-03-01' --update date
AND fp.Discharge_Date BETWEEN  '2018-03-01' AND '2019-03-01' --update date
